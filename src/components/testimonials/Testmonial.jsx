...
export default function Testimonial({ text, author, role, pic }) {
  return (
    <div
      className=" my-8"
    >
      <div className="bg-blue-800 pl-8 text-white flex lg:flex-row items-center">
        <div className="rounded-full">
          <img src={pic} alt="Author image" className="h-[284px] w-[364px] object-cover overflow-visible " />
        </div>
        <div className="bg-blue-800 p-5">
          <svg xmlns="http://www.w3.org/2000/svg" className="block w-5 h-5 mb-4" viewBox="0 0 48 48" fill="none">
